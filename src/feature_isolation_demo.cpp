/*! \file feature_isolation_demo.cpp
 *
...
int main()
{
   ...
   cout << "Model id: ";
   cin >> model_id;
   feature_location_isolation_t spl { number_of_features,model_id };
   string file_name { "feature_isolation_for_" + to_string(number_of_features) +
