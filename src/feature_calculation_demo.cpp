/*! \file feature_calculation_demo.cpp
 *
...
int main()
{
   ...
   cout << "Model id: ";
   cin >> model_id;
   feature_location_calculation_t spl { number_of_features,model_id };
   string file_name { "feature_calculation_for_" + to_string(number_of_features) +
